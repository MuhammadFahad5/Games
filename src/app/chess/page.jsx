...
import ScoreBoaredMainChess from '../mycomponent/ScoreBoaredMainChess'
                            ...
                            scoreBoard.map((data, index) => (
                                <div key={index}>
                                    ...
                                    <hr
                                        ...
                                        style={{
                                            background: 'linear-gradient(90deg, #232B36 0%, #556378 25%, #FFFFFF 50%, #556378 75%, #232B36 100%)'
                                        }}
                                    />
                                </div>
                            ))
