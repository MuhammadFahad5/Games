...
const ScoreBoaredMainTennis = () => {
    return (
        <div>
            <div className='flex justify-between rounded-[5px] score-board-main-tennis py-3 px-2 md:px-12'>
...
export default ScoreBoaredMainTennis
